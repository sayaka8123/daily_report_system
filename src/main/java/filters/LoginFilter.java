            ...
            if(ev == null) {
               //未ログイン
                if(!(ForwardConst.ACT_AUTH.getValue().equals(action) && (ForwardConst.CMD_SHOW_LOGIN.getValue().equals(command)
                    ...
                    ((HttpServletResponse) response).sendRedirect(contextPath + "?action=" + ForwardConst.ACT_AUTH.getValue()
               ...
               //ログイン済
                if(ForwardConst.ACT_AUTH.getValue().equals(action)) {
                    ...
                    if(ForwardConst.CMD_SHOW_LOGIN.getValue().equals(command)) {
                        ...
                        ((HttpServletResponse) response).sendRedirect(contextPath + "?action=" + ForwardConst.ACT_TOP.getValue()
                      ...
                      //ログアウトの実施は許可
                        ...
                        String forward = String.format("/WEB-INF/views/%s.jsp", "error/unkown");
